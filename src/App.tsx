    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" id="ambient-layers-luminous">
        ...
        {activeView === "heritage" && !selectedDetailedHeritageId && (
          <>
            <div className="absolute top-[-5%] left-[-10%] w-[650px] h-[650px] rounded-full blur-[80px] animate-float-1 will-change-transform translate-z-0 pointer-events-none" style={{ background: "rgba(0, 137, 123, 0.26)" }} />
            <div className="absolute bottom-[20%] right-[-5%] w-[600px] h-[600px] rounded-full blur-[80px] animate-float-2 will-change-transform translate-z-0 pointer-events-none" style={{ background: "rgba(46, 125, 50, 0.26)" }} />
            <div className="absolute top-[40%] left-[20%] w-[500px] h-[500px] rounded-full blur-[70px] animate-float-1 will-change-transform translate-z-0 pointer-events-none" style={{ background: "rgba(0, 150, 136, 0.2)" }} />
          </>
        )}
