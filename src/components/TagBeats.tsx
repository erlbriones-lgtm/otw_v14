          ...
          */}
          ...
          >
            <div className="max-w-md mx-auto p-8 rounded-3xl bg-emerald-50/30 border border-emerald-100/50">
              <span className="px-3 py-1 rounded-full bg-emerald-100/60 text-[9px] font-mono uppercase tracking-widest text-[#006400] font-bold" id="coming-soon-badge">
                ✨ COMING SOON
              </span>
              <h3 className="font-sans text-xl font-black text-[#006400] tracking-tight mt-4" id="coming-soon-title">
                More Music &amp; Virtual Hubs
              </h3>
              <p className="text-[#006400]/70 text-xs mt-2 leading-relaxed font-sans font-medium">
